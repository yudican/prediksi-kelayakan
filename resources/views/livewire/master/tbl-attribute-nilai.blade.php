<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>attribute nilai</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.attribute-nilai-table params="{{$route_name}}" />
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' :
                            'Tambah'}} attribute nilai</h5>
                    </div>
                    <div class="modal-body">
                        <x-select name="attribute_id" label="Attribute">
                            <option value="">Select Attribute</option>
                            @foreach ($attributes as $attribute)
                            <option value="{{$attribute->id}}">{{$attribute->nama_atribut}}</option>
                            @endforeach
                        </x-select>
                        <x-text-field type="text" name="nilai_atribut" label="Nilai Atribut" />
                    </div>
